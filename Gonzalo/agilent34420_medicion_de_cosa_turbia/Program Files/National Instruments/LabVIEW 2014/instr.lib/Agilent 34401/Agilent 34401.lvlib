...
<Library LVVersion="14008000">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Configure" Type="Folder">
			...
			<Item Name="Configure AC Filter.vi" Type="VI" URL="../Public/Configure/Configure AC Filter.vi"/>
			...
			<Item Name="Configure Integration.vi" Type="VI" URL="../Public/Configure/Configure Integration.vi"/>
			...
			<Item Name="Configure Offset Compensation.vi" Type="VI" URL="../Public/Configure/Configure Offset Compensation.vi"/>
			<Item Name="Configure Temperature.vi" Type="VI" URL="../Public/Configure/Configure Temperature.vi"/>
			<Item Name="Configure Temperature (RTD).vi" Type="VI" URL="../Public/Configure/Configure Temperature (RTD).vi"/>
			<Item Name="Configure Temperature (Thermistor).vi" Type="VI" URL="../Public/Configure/Configure Temperature (Thermistor).vi"/>
		</Item>
		<Item Name="Data" Type="Folder">
			...
			<Item Name="Read (Transient).vi" Type="VI" URL="../Public/Data/Read (Transient).vi"/>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="Save-Recall Instrument Settings.vi" Type="VI" URL="../Public/Utility/Save-Recall Instrument Settings.vi"/>
		</Item>
		<Item Name="Obsolete" Type="Folder">
			<Item Name="Fetch (Internal Buffer).vi" Type="VI" URL="../Public/Obsolete/Fetch (Internal Buffer).vi"/>
			<Item Name="Fetch (Output Buffer).vi" Type="VI" URL="../Public/Obsolete/Fetch (Output Buffer).vi"/>
			<Item Name="Fetch.vi" Type="VI" URL="../Public/Obsolete/Fetch.vi"/>
			<Item Name="Initiate (Internal Buffer).vi" Type="VI" URL="../Public/Obsolete/Initiate (Internal Buffer).vi"/>
			<Item Name="Initiate (Output Buffer).vi" Type="VI" URL="../Public/Obsolete/Initiate (Output Buffer).vi"/>
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="Fetch Measurement (Fetch).vi" Type="VI" URL="../Private/Fetch Measurement (Fetch).vi"/>
		<Item Name="Fetch Measurement (Fast Read).vi" Type="VI" URL="../Private/Fetch Measurement (Fast Read).vi"/>
		<Item Name="Fetch Measurement (Read).vi" Type="VI" URL="../Private/Fetch Measurement (Read).vi"/>
		<Item Name="Read STB.vi" Type="VI" URL="../Private/Read STB.vi"/>
	</Item>
